                    ...
                    <div style="padding:10px 0;border-bottom:1px solid var(--line)">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
                            ...
                            <div style="text-align:right">
                                <span class="t-sub" style="font-size:12px">{{ $qi['used'] }} dipakai ·
                                    {{ $qi['outstanding'] }} pending</span><br>
                                <span
                                    style="font-size:12px;font-weight:600;color:{{ $barColor }}">{{ $qi['total'] }}/{{ $qi['quota'] }}
                                    {{ $qi['item']->unit }}</span>
                            </div>
                        </div>
                        <div class="meter-row">
        ...
        <div class="card">
            ...
            <div class="card-b" style="padding:6px 0">
                        ...
                        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
                            ...
                            @if ($req->is_flagged)
                                <span class="badge b-danger" style="font-size:10px"><x-icon name="alert" width="11"
                                        height="11" style="vertical-align:-1px" /> Over-Request</span>
                            @endif
                            <span class="t-sub"
                                style="margin-left:auto;white-space:nowrap">{{ $req->request_date->format('d M') }}</span>
                        </div>
                ...
                <div style="padding:12px 18px">
                    <a href="{{ route('permintaan.index') }}" class="btn btn-pri"
