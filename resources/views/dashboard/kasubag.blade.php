    ...
    @if ($pending->count() > 0)
        <div class="notice warn mt" style="align-items:center;gap:12px">
            ...
            <div style="flex:1">
                ...
                @if ($flagged > 0)
                    <span class="t-sub"> · {{ $flagged }} di antaranya over-request.</span>
                @endif
            </div>
            <a href="{{ route('permintaan.index', ['view' => 'masuk']) }}" class="btn btn-pri btn-sm"
                style="flex:0 0 auto">Lihat &amp; Proses <x-icon name="arrow-right" width="13" height="13"
