...
<div style="display:flex;gap:10px;margin-bottom:16px;flex-wrap:wrap;align-items:center">
  ...
  <a href="{{ route('laporan.export.pdf', $exportParams) }}" class="btn btn-ghost btn-sm"><x-icon name="download" width="14" height="14" /> PDF</a>
  <a href="{{ route('laporan.export.excel', $exportParams) }}" class="btn btn-ghost btn-sm"><x-icon name="download" width="14" height="14" /> Excel</a>
</div>
