...
<div x-data="{ showModal: false, editData: {} }">
  ...
  <div class="page-head" style="display:flex;align-items:center;justify-content:space-between">
    <div><h2>Bidang / Departemen</h2><p>Unit kerja sebagai dasar pengelompokan permintaan dan kuota.</p></div>
    <button class="btn btn-pri" @click="showModal=true; editData={}"><x-icon name="plus" width="15" height="15" /> Tambah Bidang</button>
  </div>
  ...
  <div class="card">
    <div class="card-b" style="padding:0">
      <table>
        <thead><tr>
          <th>Kode</th><th>Nama Bidang</th><th>Kepala Bidang</th><th class="num">Anggota</th><th>Aksi</th>
        </tr></thead>
        <tbody>
          @forelse($bidang as $b)
            <tr>
          ...
          <form :action="editData.id ? '/bidang/'+editData.id : '/bidang'" method="POST">
            ...
            <div style="display:grid;grid-template-columns:1fr 2fr;gap:14px">
              <div class="field" style="margin:0">
                ...
                <input type="text" name="code" :value="editData.code||''" required placeholder="KEU" style="text-transform:uppercase">
              </div>
              <div class="field" style="margin:0">
                <label>Nama Bidang <span style="color:var(--danger)">*</span></label>
                <input type="text" name="name" :value="editData.name||''" required placeholder="Bidang Keuangan">
              </div>
            </div>
            ...
            <div class="field">
              ...
              <input type="text" name="description" :value="editData.description||''" placeholder="Opsional">
            </div>
